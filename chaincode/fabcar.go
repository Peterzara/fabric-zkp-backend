...
func (s *SmartContract) queryAllCarsIdemix(APIstub shim.ChaincodeStubInterface) sc.Response {

	ou, found, err := cid.GetAttributeValue(APIstub, "ou") // GetAttributeValue() only return when an idemix identity is used
	if err != nil {
